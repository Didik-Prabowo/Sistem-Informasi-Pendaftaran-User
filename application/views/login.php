    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="">Rsgistrasi</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li ><a href="<?php echo site_url();?>/auth/register">Registrasi</a></li>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="<?php echo site_url();?>/auth">Login</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
...
?>
  <form class="form-horizontal" action="<?php echo site_url();?>/auth/cekin" method="post">
