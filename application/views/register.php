      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
           <li class="active"><a href="<?php echo site_url();?>auth">Registrasi</a></li>
...
?>
  <form class="form-horizontal" action="<?php echo site_url();?>/auth/register" method="post">
